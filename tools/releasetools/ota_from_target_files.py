...
""" % bcb_dev)
  ...
  if target_info.GetBuildProp("ro.sacred.modversion") is not None:
    buildid = target_info.GetBuildProp("ro.sacred.modversion")
    ...
    device = target_info.GetBuildProp("ro.sacred.device")
    androidver = target_info.GetBuildProp("ro.build.version.release")
    sdkver = target_info.GetBuildProp("ro.build.version.sdk")
    script.Print(" **************** Build Info *****************");
